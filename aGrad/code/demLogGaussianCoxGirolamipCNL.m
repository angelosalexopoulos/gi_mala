...
if storeRes == 1
    ...
    if rep == 1
       save(['results/Cox_regression/' dataName '_repeat' num2str(rep) '.mat'], 'summarypCNL', 'LogL', 'model', 'samples');
    else
       save(['results/Cox_regression/' dataName '_repeat' num2str(rep) '.mat'], 'summarypCNL', 'LogL');
    end
end
